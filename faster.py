...
async def worker(num_codes, webhook_url):
...
def main(num_codes, num_threads, webhook_url):
    ...
    codes_per_worker = 1000  # Each worker will handle 1000 codes
    threads = []
...
if __name__ == "__main__":
    ...
    try:
        ...
        if total_codes_to_generate < 1:
            ...
            num_threads = min(total_codes_to_generate // 1000, 100)  # Max 100 threads, with 1000 codes each
            ...
            main(total_codes_to_generate, num_threads, webhook_url)
